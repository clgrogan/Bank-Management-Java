...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Checking checking = new Checking(
                ...
                "Michael Scott",
                new BigDecimal(1524.51));
        Savings savings = new Savings("ce07d7b3-9038-43db-83ae-77fd9c0450c9", "Saul Goodman", new BigDecimal(2241.60));
        Loan loan = new Loan("4991bf71-ae8f-4df9-81c1-9c79cff280a5", "Phoebe Buffay", new BigDecimal(2537.31));
    }
